...
import { 
  ...
  Archive // הוספתי את האייקון החסר
} from 'lucide-react';
...
const AVATARS: Record<string, string> = {
  ...
  'שארק 30': 'https://i.postimg.cc/6qH6mQYp/shark30-logo.jpg',
  'כראדי 32': 'https://i.postimg.cc/xT0sM6yV/karadi32-logo.jpg',
  'שי שרון': 'https://i.postimg.cc/Y9x9zYyF/shai-sharon-logo.jpg'
};
...
export default function MasterDashboard() {
  ...
  const calculateTimer = (targetTime: string) => {
    ...
    return { 
      ...
      isPast, 
      isUrgent: !isPast && minutesLeft < 60 
    };
  };
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 overflow-x-auto pb-6 scrollbar-hide">
            {containerOrders.map(c => {
              ...
              return (
                <div key={c.id} className="bg-white p-7 rounded-[2.5rem] shadow-xl border border-slate-100 border-r-[14px] border-r-blue-500 min-w-[320px]">
                  ...
                  <div className="flex justify-between items-center gap-4 pt-5 border-t border-slate-100">
                    ...
                    <div className="text-center flex-shrink-0">
                       <img src={AVATARS[c.contractor_name] || `https://ui-avatars.com/api/?name=${c.contractor_name}&background=random`} className="w-12 h-12 rounded-xl object-cover border-2 border-blue-100 shadow-sm mb-1" />
