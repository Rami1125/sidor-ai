...
import { Menu, X, Truck, Box, MessageSquare, Settings, ChevronLeft, Bell } from 'lucide-react';
...
const teamMembers = [
  ...
  { name: 'נתנאל ח. סבן', role: 'קניין', avatar: 'https://media-mrs2-3.cdn.whatsapp.net/v/t61.24694-24/467941675_543027198650536_1927742493184989891_n.jpg?stp=dst-jpg_s96x96_tt6&ccb=11-4&oh=01_Q5Aa4AGRrdYa7CA723729zlwkwChykGTGRtx5N82AG7Yx5IIOg&oe=69D9A3AF&_nc_sid=5e03e0&_nc_cat=105' },
    ...
    <div className="min-h-screen bg-[#F8F9FA] text-[#111B21] font-sans" dir="rtl">
      ...
      <header className="fixed top-0 left-0 right-0 h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 z-[100] px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
           <div className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-700 font-bold text-xs">RM</div>
        </div>
      </header>
